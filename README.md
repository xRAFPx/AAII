...
Este trabalho tem como objetivo a criação de um bom modelo de previsão de novos casos confirmados e de óbitos por COVID-19, para cada uma das regiões de Portugal Continental e Ilhas (Açores e Madeira).
